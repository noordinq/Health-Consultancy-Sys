...
public class AdminLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminPageQtn = findViewById(R.id.adminPageQtn);
        loader = new ProgressDialog(this);
        mAuth = FirebaseAuth.getInstance();

        adminPageQtn.setOnClickListener(new View.OnClickListener() {
            @Override
                                ...
                                ref.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        if (type.equals("Admin")){
                                            ...
                                            Toast.makeText(AdminLoginActivity.this, "You are not an admin, Please login from the login page", Toast.LENGTH_LONG).show();
